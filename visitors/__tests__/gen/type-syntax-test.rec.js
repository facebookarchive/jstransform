...
module.exports = {
    'TypeAnnotations': {
        ...
        'function foo():number{}': {
            ...
            transformed: 'function foo() /*number*/{}',
            eval: 'No error',

        },
        'function foo():() => void{}': {
            raworiginal: 'function foo():() => void{}',
            transformed: 'function foo() /*function*/{}',
            eval: 'No error',

        },
        'function foo():(_:bool) => number{}': {
            raworiginal: 'function foo():(_:bool) => number{}',
            transformed: 'function foo() /*function(boolean):number*/{}',
            eval: 'No error',
        ...
        'function foo(): {} {}': {
            ...
            transformed: 'function foo() /*object*/ {}',
            eval: 'No error',
        ...
        'a={set fooProp(value:number){}}': {
            ...
            transformed: 'a={set fooProp(/*number*/ value){}}',
            eval: 'No error',
        ...
        'var a:Array<number> = [1, 2, 3]': {
            ...
            transformed: 'var /*array<number>*/ a = [1, 2, 3]',
            eval: 'No error',
        ...
        'class Foo<T> { bar<U>():number { return 42; }}': {
            ...
            transformed: 'class Foo<T> { bar<U>() /*number*/ { return 42; }}',
            eval: 'Unexpected reserved word',
        ...
        'var a:(...rest:Array<number>) => number': {
            ...
            transformed: 'var /*function():number*/ a',
            eval: 'No error',
    ...
    'String Literal Types': {
        'function createElement(tagName: "div"): HTMLDivElement {}': {
            ...
            transformed: 'function createElement(tagName) /*HTMLDivElement*/ {}',
            eval: 'No error',
